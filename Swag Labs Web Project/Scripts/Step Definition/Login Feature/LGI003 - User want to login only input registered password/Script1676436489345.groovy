...
WebUI.callTestCase(findTestCase('Login Page/Input Username'), [('username') : ''], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Login Page/Read Error Message'), [('expected') : 'Epic sadface: Username is required'], 
